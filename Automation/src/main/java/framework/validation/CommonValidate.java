...
public class CommonValidate
{
    ...
    public static final String SCREENSHOT_LOCATION = System.getProperty("user.dir") + System.getProperty("file.separator") + "test-output"  + System.getProperty("file.separator") +   "screenshots";
