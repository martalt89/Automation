...
public class BookVisitTest extends TestBase {
    ...
    public void BookVisitWithInsurance() throws Exception {
        ...
        loginPage.oUserNameInput.sendKeys(email);
        loginPage.oPasswordInput.sendKeys(password);
        ...
        paymentPage.oAddInsuranceBtn.clickAndWait(menu.oLoadingBar, false);
        manageProfilePage.oInsuranceProviderInput.selectByVisibleTextAngular("Anthem");
        manageProfilePage.oMemberIdInput.sendKeys("COST_ESTIMATES_025");
        manageProfilePage.oGroupIdInput.sendKeys("X0001004");
