...
//    private static HealEntityManager oEm = null;
     ...
     * oWebValidate stores WebValidate object per test thread.
    ...
    /**
     * Stores WebValidate instance in InheritableThreadLocal variable.
     *
     * @param oV
     * (WebValidate)
     */
    public void setValidate(CommonWebValidate oV)
    {
    ...
    /**
     * Retrieves WebValidate instance stored in InheritableThreadLocal variable.
     *
     * @return
     * (WebValidate)
     */
        ...
        try
        {
            ...
            if (bGridMode)
            {
                if (grid_server_url.equals(""))
                    throw new org.testng.SkipException("Parameter 'grid_server_url' must be provided when running in grid mode!");
            ...
            // Set global throttling value for HealWebElement
            com.heal.framework.web.CommonWebElement.setThrottle(Integer.parseInt(element_action_throttle));
            logger.info("setup():  Element action throttle:  {} sec", element_action_throttle);

            // Set global implicit wait value for HealWebElement
            com.heal.framework.web.CommonWebElement.setImplicitWait(Integer.parseInt(element_implicit_wait));
...
//            oEm.close();
    ...
    public void beforeMethod(Object[] aParams, java.lang.reflect.Method oMethod) throws Exception
    {
        ...
        if (aParams.length == 0)
        {
            setValidate(new CommonWebValidate(null, false));
            return;
        }
    ...
    public Object[][] GetTestParameters(java.lang.reflect.Method oMethod, ITestContext context)
    {
        ...
        // Remove from target browser array the browser that we need to skip
        boolean match = false;
    ...
    public String handleException(Throwable ex)
    {
        try
        {
            ...
            {
                if(ex instanceof com.heal.framework.exception.CommonException)    		// No screenshot necessary.
                    return "";
...
//					FirefoxProfile profile = new FirefoxProfile(new java.io.File(sFirefoxProfile));
    ...
    /**
     * Wrapper around WebValidate.verifyLinkNavigation method in ThreadLocal
     *
     * @param sComment
     * @param oStartPage
     * @param oLink
    ...
    /**
     * Wrapper around WebValidate.verifyLinkPopup method in ThreadLocal
     *
     * @param sComment
     * @param oStartPage
     * @param oLink
    ...
    /**
     * Wrapper around WebValidate.verifyAttribute method in ThreadLocal
     *
     * @param sComment
     * @param oTarget
     * @param sAttibName
    ...
    /**
     * Wrapper around WebValidate.verifyCssValue method in ThreadLocal
     *
     * @param sComment
     * @param oTarget
     * @param sCssProp
    ...
    /**
     * Wrapper around WebValidate.verifyElementText method in ThreadLocal
     *
     * @param sComment
     * @param oTarget
     * @param sExpectedText
    ...
    /**
     * Wrapper around WebValidate.verifyTextEquals method in ThreadLocal
     *
     * @param sComment
     * @param oTarget
     * @param sExpected
    ...
    /**
     * Wrapper around WebValidate.verifyTextMatches method in ThreadLocal
     *
     * @param sComment
     * @param oTarget
     * @param sExpected
